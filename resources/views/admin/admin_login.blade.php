             				...
             				@csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Enter email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
								  ...
								  <div class="row">
									...
									<div class="col-12 text-center">
									  <button type="submit" class="btn btn-info btn-rounded mt-10"><strong>SIGN IN</strong></button>
									</div>
									<!-- /.col -->
								  </div>
							</form>														
